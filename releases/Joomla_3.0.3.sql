...
--
-- Host: localhost
-- Generation Time: Sep 16, 2013 at 02:00 PM
...
--
-- Database: `Joomla_3.0.3`
--

-- --------------------------------------------------------

--
-- Table structure for table `j30_assets`
--

CREATE TABLE IF NOT EXISTS `j30_assets` (
...
--
-- Dumping data for table `j30_assets`
--

INSERT INTO `j30_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `j30_associations`
--

CREATE TABLE IF NOT EXISTS `j30_associations` (
...
--
-- Table structure for table `j30_banners`
--

CREATE TABLE IF NOT EXISTS `j30_banners` (
...
--
-- Table structure for table `j30_banner_clients`
--

CREATE TABLE IF NOT EXISTS `j30_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `j30_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `j30_banner_tracks` (
...
--
-- Table structure for table `j30_categories`
--

CREATE TABLE IF NOT EXISTS `j30_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j30_categories`
--

INSERT INTO `j30_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `j30_contact_details`
--

CREATE TABLE IF NOT EXISTS `j30_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `j30_content`
--

CREATE TABLE IF NOT EXISTS `j30_content` (
...
--
-- Table structure for table `j30_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `j30_content_frontpage` (
...
--
-- Table structure for table `j30_content_rating`
--

CREATE TABLE IF NOT EXISTS `j30_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `j30_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `j30_core_log_searches` (
...
--
-- Table structure for table `j30_extensions`
--

CREATE TABLE IF NOT EXISTS `j30_extensions` (
...
--
-- Dumping data for table `j30_extensions`
--

INSERT INTO `j30_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `j30_finder_filters`
--

CREATE TABLE IF NOT EXISTS `j30_finder_filters` (
...
--
-- Table structure for table `j30_finder_links`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links` (
...
--
-- Table structure for table `j30_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms0` (
...
--
-- Table structure for table `j30_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `j30_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `j30_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `j30_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `j30_finder_taxonomy`
--

INSERT INTO `j30_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `j30_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `j30_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `j30_finder_terms`
--

CREATE TABLE IF NOT EXISTS `j30_finder_terms` (
...
--
-- Table structure for table `j30_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `j30_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `j30_finder_terms_common`
--

INSERT INTO `j30_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `j30_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `j30_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `j30_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `j30_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `j30_finder_types`
--

CREATE TABLE IF NOT EXISTS `j30_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `j30_languages`
--

CREATE TABLE IF NOT EXISTS `j30_languages` (
...
--
-- Dumping data for table `j30_languages`
--

INSERT INTO `j30_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `j30_menu`
--

CREATE TABLE IF NOT EXISTS `j30_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j30_menu`
--

INSERT INTO `j30_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `j30_menu_types`
--

CREATE TABLE IF NOT EXISTS `j30_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j30_menu_types`
--

INSERT INTO `j30_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `j30_messages`
--

CREATE TABLE IF NOT EXISTS `j30_messages` (
...
--
-- Table structure for table `j30_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `j30_messages_cfg` (
...
--
-- Table structure for table `j30_modules`
--

CREATE TABLE IF NOT EXISTS `j30_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j30_modules`
--

INSERT INTO `j30_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `j30_modules_menu`
--

CREATE TABLE IF NOT EXISTS `j30_modules_menu` (
...
--
-- Dumping data for table `j30_modules_menu`
--

INSERT INTO `j30_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `j30_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `j30_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `j30_overrider`
--

CREATE TABLE IF NOT EXISTS `j30_overrider` (
...
--
-- Table structure for table `j30_redirect_links`
--

CREATE TABLE IF NOT EXISTS `j30_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `j30_schemas`
--

CREATE TABLE IF NOT EXISTS `j30_schemas` (
...
--
-- Dumping data for table `j30_schemas`
--

INSERT INTO `j30_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.0.3');

-- --------------------------------------------------------

--
-- Table structure for table `j30_session`
--

CREATE TABLE IF NOT EXISTS `j30_session` (
...
--
-- Dumping data for table `j30_template_styles`
--

INSERT INTO `j30_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `j30_updates`
--

CREATE TABLE IF NOT EXISTS `j30_updates` (
...
--
-- Table structure for table `j30_update_sites`
--

CREATE TABLE IF NOT EXISTS `j30_update_sites` (
...
--
-- Dumping data for table `j30_update_sites`
--

INSERT INTO `j30_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
...
--
-- Table structure for table `j30_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `j30_update_sites_extensions` (
...
--
-- Dumping data for table `j30_update_sites_extensions`
--

INSERT INTO `j30_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `j30_usergroups`
--

CREATE TABLE IF NOT EXISTS `j30_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `j30_usergroups`
--

INSERT INTO `j30_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `j30_users`
--

CREATE TABLE IF NOT EXISTS `j30_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `j30_users`
--

INSERT INTO `j30_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(517, 'Super User', 'admin', 'khai_aaa85@yahoo.com', '50a54f8652553b66a8b6eccd62de5aaa:7TJrx8dtXnBThuH6T5IwMwYlpT44UxuH', 0, 1, '2013-09-16 07:00:41', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `j30_user_notes`
--

CREATE TABLE IF NOT EXISTS `j30_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `j30_user_profiles`
--

CREATE TABLE IF NOT EXISTS `j30_user_profiles` (
...
--
-- Table structure for table `j30_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `j30_user_usergroup_map` (
...
--
-- Dumping data for table `j30_user_usergroup_map`
--

INSERT INTO `j30_user_usergroup_map` (`user_id`, `group_id`) VALUES
(517, 8);

-- --------------------------------------------------------

--
-- Table structure for table `j30_viewlevels`
--

CREATE TABLE IF NOT EXISTS `j30_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `j30_viewlevels`
--

INSERT INTO `j30_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `j30_weblinks`
--

CREATE TABLE IF NOT EXISTS `j30_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
