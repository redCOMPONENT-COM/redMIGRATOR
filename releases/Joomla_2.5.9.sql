...
--
-- Host: localhost
-- Generation Time: Sep 16, 2013 at 12:24 PM
...
CREATE TABLE IF NOT EXISTS `j25_assets` (
...
INSERT INTO `j25_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_associations` (
...
CREATE TABLE IF NOT EXISTS `j25_banners` (
...
CREATE TABLE IF NOT EXISTS `j25_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `j25_banner_tracks` (
...
CREATE TABLE IF NOT EXISTS `j25_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `j25_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `j25_content` (
...
CREATE TABLE IF NOT EXISTS `j25_content_frontpage` (
...
CREATE TABLE IF NOT EXISTS `j25_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `j25_core_log_searches` (
...
CREATE TABLE IF NOT EXISTS `j25_extensions` (
...
INSERT INTO `j25_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_finder_filters` (
...
CREATE TABLE IF NOT EXISTS `j25_finder_links` (
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms0` (
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
CREATE TABLE IF NOT EXISTS `j25_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
INSERT INTO `j25_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `j25_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `j25_finder_terms` (
...
CREATE TABLE IF NOT EXISTS `j25_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
INSERT INTO `j25_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
CREATE TABLE IF NOT EXISTS `j25_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `j25_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `j25_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `j25_languages` (
...
INSERT INTO `j25_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `j25_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `j25_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_messages` (
...
CREATE TABLE IF NOT EXISTS `j25_messages_cfg` (
...
CREATE TABLE IF NOT EXISTS `j25_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `j25_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_modules_menu` (
...
INSERT INTO `j25_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
CREATE TABLE IF NOT EXISTS `j25_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `j25_overrider` (
...
CREATE TABLE IF NOT EXISTS `j25_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `j25_schemas` (
...
INSERT INTO `j25_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.9');
...
CREATE TABLE IF NOT EXISTS `j25_session` (
...
CREATE TABLE IF NOT EXISTS `j25_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `j25_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_updates` (
...
CREATE TABLE IF NOT EXISTS `j25_update_categories` (
...
CREATE TABLE IF NOT EXISTS `j25_update_sites` (
...
INSERT INTO `j25_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
...
CREATE TABLE IF NOT EXISTS `j25_update_sites_extensions` (
...
INSERT INTO `j25_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
CREATE TABLE IF NOT EXISTS `j25_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
INSERT INTO `j25_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
CREATE TABLE IF NOT EXISTS `j25_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO `j25_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(762, 'Super User', 'admin', 'khai_aaa85@yahoo.com', 'ccd2dfbbc37ab6da1f6f72bca0f3e220:Rl26oLyQuZj1W5a6B4GZmAtq7HqzUUgJ', 'deprecated', 0, 1, '2013-09-16 05:23:54', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0);
...
CREATE TABLE IF NOT EXISTS `j25_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `j25_user_profiles` (
...
CREATE TABLE IF NOT EXISTS `j25_user_usergroup_map` (
...
INSERT INTO `j25_user_usergroup_map` (`user_id`, `group_id`) VALUES
(762, 8);
...
CREATE TABLE IF NOT EXISTS `j25_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
INSERT INTO `j25_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
CREATE TABLE IF NOT EXISTS `j25_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
