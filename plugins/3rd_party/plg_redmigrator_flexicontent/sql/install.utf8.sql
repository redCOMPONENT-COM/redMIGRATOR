...
--
-- Table structure for table `#__flexicontent_advsearch_index`
--
...
--
-- Table structure for table `#__flexicontent_authors_ext`
--
...
--
-- Table structure for table `#__flexicontent_cats_item_relations`
--
...
--
-- Table structure for table `#__flexicontent_download_coupons`
--
...
--
-- Table structure for table `#__flexicontent_download_history`
--
...
--
-- Table structure for table `#__flexicontent_favourites`
--
...
--
-- Table structure for table `#__flexicontent_fields`
--
...
--
-- Table structure for table `#__flexicontent_fields_item_relations`
--
...
--
-- Table structure for table `#__flexicontent_fields_type_relations`
--
...
--
-- Table structure for table `#__flexicontent_files`
--
...
--
-- Table structure for table `#__flexicontent_items_ext`
--
...
--
-- Table structure for table `#__flexicontent_items_extravote`
--
...
--
-- Table structure for table `#__flexicontent_items_versions`
--
...
--
-- Table structure for table `#__flexicontent_tags`
--
...
--
-- Table structure for table `#__flexicontent_tags_item_relations`
--
...
--
-- Table structure for table `#__flexicontent_templates`
--
...
--
-- Table structure for table `#__flexicontent_types`
--
...
--
-- Table structure for table `#__flexicontent_versions`
--
